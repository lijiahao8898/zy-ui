            ...
            <template v-for="(item, index) in column">
                <el-table-column :label="item.label" :prop="item.prop" :type="item.type" :width="item.width"
                    ...
                    <template slot-scope="scope">
                        ...
                        <div v-else-if="item.render && typeof item.render === 'function'">
                            <table-render :render="item.render" :row="scope.row" :column="item"></table-render>
                        </div>
                        <!-- 默认纯展示数据 -->
                        <div v-else>
